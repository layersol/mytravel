...
class BlogController extends Controller
{
    ...
    public function blogSave(Request $request){
        $request->validate([
            ...
            'content' => 'required',
            'image' => 'required|image|mimes:jpeg,png,jpg,svg|max:2048', // Validating image format and size
        ...
        $blog = new Blog([
         ...
         return redirect()->route('/settings/blogs.index')->with('success', 'Blog created successfully.');
    ...
    public function blogUpdate(Request $request, $id)
    {
        ...
        // Redirect back with a success message
        return redirect()->route('/settings/blogs.index')->with('success', 'Blog updated successfully.');
    }
    ...
    public function blogDelete(Request $request, $id)
  {
    ...
    // Redirect back with a success message
    return redirect()->route('/settings/blogs.index')->with('success', 'Blog deleted successfully.');
  }
