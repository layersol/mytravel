...
class SettingController extends Controller
{
    public function sectionsIndex(){
        $sections = SectionsContent::all()->toArray();
        return view('backend/contents/sections/section',compact('sections'));
    }

    public function sectionsEdit(Request $request,$id){
        $section=SectionsContent::findOrfail($id)->toArray();
        return view('backend/contents/sections/section-update',compact('section'));
  ...
  ///////////////////////// section methods end ///////////////////
    ...
    public function siteIdentityUpdate(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'logo_image' => 'nullable|mimes:jpeg,jpg,png,gif|max:2048',
        ]);
  ...
  ///////////////////////// site identity methods end ///////////////////
    ...
    public function index(){
        $testimonials = Testimonial::orderBy('created_at', 'desc')->get()->toArray();
    ...
    public function update(Request $request, $id)
{
  ...
  ///////////////////////// testimonials identity methods end ///////////////////
    ...
    public function aboutPageIndex(){
        ...
        return view('backend/contents/pages/about-page',compact('about'));
    }
    
    public function aboutPageUpdate(Request $request, $id)
    {
        // Validate the incoming form data
        $request->validate([
        ...
        if ($request->hasFile('image')) {
            // Delete the old image if it exists
            if ($about->image) {
                Storage::disk('public')->delete('images/pages/' . $about->image);
            }
            ...
            $about->image = $imageName; // Store the unique name in the AboutPage model
        }
    
        // Update the AboutPage properties if they are present in the request
  ...
  public function contactPageUpdate(Request $request, $id)
  {
    ...
    $request->validate([
        ...
        'social_media.*' => 'nullable|url', // Validate each social media link as a URL
    ]);
    ...
    $contact->social_media = json_encode($request->input('social_media'));
  ...
  /////////////////////// terms page //////////////////////////////////////
    public function termsIndex(){
        $terms=TermsPrivacy::all()->toArray();
