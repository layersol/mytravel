...
class RolesandPermissionsController extends Controller
{
   ...
   public function rolesStore(Request $request)
  {
    ...
    return redirect()->route('RolesandPermissions/roles.index')->with('success','Role Created');
  }
   /**
     * Role Edit form .
     */
  ...
  public function rolesUpdate(Request $request, Role $role)
  {
      ...
      return redirect()->route('RolesandPermissions/roles.index')->with('success','Role Updated');
  }
  ...
  /**
    ...
    public function permissionsStore(Request $request){
        ...
        return redirect()->route('RolesandPermissions/permissions.index')->with('success',' Permissions Created');
    }
     /**
     * Permissions creat request .
     */
    ...
    public function permissionUpdate(Request $request, Permission $permission)
  {
      ...
      return redirect()->route('RolesandPermissions/permissions.index')->with('success','Permission Updated');
  }
}