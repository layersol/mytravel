            ...
            <div class="container space-3 space-top-xl-2">
                <div class="row justify-content-md-center" style="margin-bottom: -8%;">
                    ...
                    <div class="py-8 py-xl-10 pb-5">
                        <h1 class="font-size-60 font-size-xs-30 text-white font-weight-bold">Flight To {{ $deal->area_name }}
                        </h1>
                        <p class="font-size-20 font-weight-normal text-white">Find best deals in {{ $deal->area_name }}</p>
                    </div>
                    <!-- End Info -->
                </div>
                <div class="mb-lg-n16 ">
                            ...
                            <div class="card border-0 tab-shadow">
                                <div class="card-body">
                                    ...
                                    <form class="js-validate" action="{{ route('flight-list') }}">
                                        ...
                                        <input type="hidden" name="arrival_code" id="arrival_code" value="{{ $deal->iata_code }}">
                                                ...
                                                <div class="js-focus-state">
                                                    <div class="input-group border-bottom border-width-2 border-color-1">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            required onclick="this.value=''" value="{{ $deal->airport_name }}">
                                                    </div>
                                                </div>
                                                <!-- End Input -->
                                            </div>
        ...
        <div class="border-bottom border-color-8">
            <div class="container space-bottom-1 space-top-lg-3">
                <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-4 mb-xl-7 pb-xl-1">
                    <h2 class="section-title text-black font-size-30 font-weight-bold mb-0">Looking For Cheap Flight To {{ $deal->area_name }}</h2>
                </div>
