...
<div class="col-lg-4 col-xl-3">
    <div class="shadow-soft bg-white rounded-sm">
        @foreach ($selectedData->itineraries as $itiKey => $iti)
            @php
                ...
                <div id="basicsCollapseThree" class="collapse " aria-labelledby="basicsHeadingThree"
                    ...
                    <div class="card-body px-4 pt-0">
                        ...
                        <ul class="list-unstyled font-size-1 mb-0 font-size-16">
                           ...
                           @foreach ($selectedData->travelerPricings as $priceData)
                    ...
                    <div class="card-body px-4 pt-0">
                        ...
                        <ul class="list-unstyled font-size-1 mb-0 font-size-16">
                            <li class="d-flex justify-content-between py-2">
                                ...
                                <span
                                    class="text-secondary">{{ getCurrencySymbol($selectedData->price->currency) . '  ' . $selectedData->price->base }}</span>
                            </li>

                            <li class="d-flex justify-content-between py-2">
                                <span class="font-weight-medium">Taxes</span>
                                <span
                                    class="text-secondary">{{ getCurrencySymbol($selectedData->price->currency) . '  ' . $selectedData->price->total - $selectedData->price->base }}</span>
                            </li>

                            <li class="d-flex justify-content-between py-2 font-size-17 font-weight-bold">
                                <span class="font-weight-bold">Pay Amount</span>
                                <span
                                    class="">{{ getCurrencySymbol($selectedData->price->currency) . '  ' . $selectedData->price->grandTotal }}</span>
                            </li>
                        @if (isset($result))
                                <hr>
                            <li class="d-flex justify-content-between py-2 font-size-17 font-weight-bold">
