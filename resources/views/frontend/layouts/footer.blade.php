 ...
 <footer class="footer footer-border-top" style="background-color: #1a0b24;">
                ...
                <div class="col-12 col-lg-3 col-md-6 order-md-0">
                    ...
                    <div class="d-md-flex d-lg-block">
                        <div class="mb-5 mr-md-7 mr-lg-0">
                            ...
                            <p style="color:#d5d5d5">Make My Booking is the Registered Travel Agency based in UK providing the best travel solution from UK to around the globe.</p>
                            ...
                            <div>
                                ...
                                <address>
                                    <p class="h6 font-weight-normal text-gray-1" style="color:#d5d5d5 !important">
                                        ...
                                        <span class="ml-5">Sat: 10:00 - 14:00,</span> <br>
                                        <span class="ml-5">Sun: Closed</span>
                                    </p>
                                </address>
                            </div>
                        </div>
  ...
  <div style="align-items: center">
        <div class="container">
            <div class="d-lg-flex d-md-block justify-content-between align-items-center" style=" display: flex  !important;justify-content: center !important;">
                ...
                <p class="text-muted text-gray-1">
                    ©{{ date('Y') }} All Rights Reserved by Make My Booking</p>
                <!-- End Copyright -->
                <!-- Social Networks -->
                <!-- End Social Networks -->
            </div>
        ...
        <script src="{{ url('assets/frontend/vendor/svg-injector/dist/svg-injector.min.js') }}"></script>
        ...
        <script src="{{ url('assets/frontend/js/components/hs.svg-injector.js') }}"></script>
            ...
            if (currentInput.value.trim() !== '') {
                ...
                for (var i = currentIndex + 1; i < formInputs.length; i++) {
                    ...
                    if (currentInput.name === 'departure_full' || currentInput.name === 'arrival_full') {
                        ...
                        if (nextInput.name == 'departure_date') {
