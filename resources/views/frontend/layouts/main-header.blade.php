...
<html lang="en">
    <head>
        <!-- Title -->
        <title>My Travel Booking Website</title>
                      ...
                      <div id="navBar" class="navbar-collapse u-header__navbar-collapse collapse order-2 order-xl-0 pt-4 p-xl-0 position-relative mx-n3 mx-xl-0">
                          <ul class="navbar-nav u-header__navbar-nav">
                            ...
                            <li class="nav-item u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
                                <a id="yachtMenu" class="nav-link u-header__nav-link  u-header__nav-link-border" href="https://wa.me/+441213181100" aria-haspopup="true" aria-expanded="false" > <span class="fab fa-whatsapp mr-2"> </span>Chat With Us</a>
                                
                            </li>
                            <!-- End About -->
                              <!-- About -->
                              <li class="nav-item u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
                                  <a id="yachtMenu" class="nav-link u-header__nav-link  u-header__nav-link-border" href="{{ route('/about') }}" aria-haspopup="true" aria-expanded="false" >About Us</a>
                              ...
                              <!-- About -->
                              <li class="nav-item u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
                                <a id="yachtMenu" class="nav-link u-header__nav-link  u-header__nav-link-border" href="{{ route('/contact') }}" aria-haspopup="true" aria-expanded="false" >Contact Us</a>
                               
                              </li>

                              <ul class="list-inline mb-0 mr-2 pr-1">
                                @foreach(json_decode(getContactDetails()->social_media) as $socialMedia => $link)
                                    <li class="list-inline-item ">
                                        <a class="btn btn-sm btn-icon btn-pill btn-white btn-soci transition-3d-hover nav-item-color" href="{{ $link }}" target="_blank">
                                            <span class="{{ getSocialMediaIconClass($socialMedia) }} btn-icon__inner"></span>
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
                            ...
                            <li class="nav-item u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
                                ...
                                <a id="hotelMenu" class="nav-link  u-header__nav-link u-header__nav-link-border font-size-24  font-weight-lighter" href="tel:01213181100" aria-haspopup="true" aria-expanded="false" aria-labelledby="hotelSubMenu">
