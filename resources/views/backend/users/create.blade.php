      ...
      <div class="dashboard__content bg-light-2">
        <div class="row y-gap-20 justify-between items-end pb-60 lg:pb-40 md:pb-32">
          <div class="col-auto">
            ...
            <h1 class="text-30 lh-14 fw-600">Add User</h1>
            <div class="text-15 text-light-1">You can create new user from here.</div>
                ...
                <div class="col-xl-9">
                  <div class="row x-gap-20 y-gap-20">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-input ">
                        <x-text-input id="mobile" name="mobile" type="number" :value="old('mobile')"/>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-input ">
                        <x-text-input id="password" name="password" type="password" :value="old('password')" required/>
                    ...
                    <div class="col-12">
                      ...
                      <div class="form-input ">
                        <x-text-input id="address" name="address" type="address" :value="old('address')"/>
