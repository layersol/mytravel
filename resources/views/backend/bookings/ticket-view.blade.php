                                ...
                                <div class="js-accordion">
                                    <div class="accordion__item py-30 px-30 bg-white rounded-4 base-tr"
                                        ...
                                        <div class="row y-gap-30 justify-between">
                                            <div class="col">
                                               @php
                                                   $details=json_decode($ticket->live_details);
                                                   
                                               @endphp
                                             {{-- loop start here  --}}
                                             @foreach ($details->data->flightOffers as $offer)
                                                @foreach ($offer->itineraries as $itiKey =>$iti)
                                                    @php
                                                ...
                                                <div class="row y-gap-10 items-center">
                                                    ...
                                                    <div class="col">
                                                        <div class="row x-gap-20 items-end">
                                                            ...
                                                            <div class="col-auto">
                                                                <div class="lh-15 fw-500">{{ formatTime($first_segment->departure->at,'H:i') }}</div>
                                                                <div class="text-15 lh-15 text-light-1">{{ $first_segment->departure->iataCode }}</div>
                                                            </div>

                                                            <div class="col text-center">
                                                                
                                                               <i class="fa-solid fa-plane  {{$itiKey==1 ?'fa-rotate-180':''}}"></i>
                                                                <div class="text-15 lh-15 text-light-1 mt-10">
                                                                    {{ formatTime($first_segment->departure->at,'M-d-Y') }}</div>
                                                            </div>

                                                            <div class="col-auto">
                                                                <div class="lh-15 fw-500">{{ formatTime($last_segment->arrival->at,'H:i') }}</div>
                                                                <div class="text-15 lh-15 text-light-1">{{ $last_segment->arrival->iataCode }}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                   
                                                    <div class="col-auto" style="border-left:1px solid #DDDDDD">                                                   
                                                        Flight No: {{ $first_segment->carrierCode . ' ' . $first_segment->number}}
                                                    </div>
                                                     </div>
                                                     @endforeach
                                                    @endforeach
