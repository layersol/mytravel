      ...
      <div class="dashboard__content bg-light-2">
        <div class="row y-gap-20 justify-between items-end pb-60 lg:pb-40 md:pb-32">
          <div class="col-auto">
            ...
            <h1 class="text-30 lh-14 fw-600">Update Airport</h1>
            <div class="text-15 text-light-1">You can update airport data from here.</div>
                  ...
                  <div class="row x-gap-20 y-gap-20">
                    ...
                    <div class="col-md-9">
                      ...
                      <div class="form-input">
                        <x-text-input id="name" name="name" type="text" :value="old('name',$airport->name)" required/>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-input">
                          <x-text-input id="iata" name="iata" type="text" :value="old('iata',$airport->iata)" required/>
                      ...
                      <div class="col-lg-8">
                        ...
                        <div class="select js-select js-liveSearch" data-select-value="">
                          <button class="select__button js-button" type="button">
                            <span class="js-button-title text-light-1">{{ $airport->country }}</span>
                            <input type="hidden" name="country" class="countryname" value="{{ old('country',$airport->country) }}">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-input">
                          <x-text-input id="city" name="city" type="text" :value="old('city',$airport->city)" required/>
