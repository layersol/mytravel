      ...
      <div class="dashboard__content bg-light-2">
        <div class="row y-gap-20 justify-between items-end pb-60 lg:pb-40 md:pb-32">
          <div class="col-auto">
            ...
            <h1 class="text-30 lh-14 fw-600">Add Deal</h1>
            <div class="text-15 text-light-1">You can create new deal from here.</div>
          ...
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
               ...
               <form action="{{route('travel-deals.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row x-gap-20 y-gap-20">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-input">
                        <x-text-input id="airport_name" name="airport_name" type="text" :value="old('airport_name')" required/>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-input">
                        <x-text-input id="area_name" name="area_name" type="text" :value="old('area_name')" required/>
                    ...
                    <div class="col-md-2">
                      ...
                      <div class="form-input ">
                        <x-text-input id="iata_code" name="iata_code" type="text" :value="old('iata_code')" required/>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-input ">
                        <x-text-input id="starting_price" name="starting_price" type="text" :value="old('starting_price')" required/>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-input ">
                        <x-text-input id="currency" name="currency" type="text" :value="old('currency')" required/>
