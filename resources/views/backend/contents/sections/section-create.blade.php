            ...
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls d-flex justify-content-between">
              ...
              <div class="col-auto">
                ...
                <a href="{{ route('/settings/section.add',$section['id']) }}" class="button h-50 px-24 -dark-1 bg-blue-1 text-white">
                    ...
                    <form method="post" action="{{ route('/settings/section.create', $section['id']) }}" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        ...
                        <div class="tabs__content pt-30 js-tabs-content">
                            <div class="tabs__pane -tab-item-1 is-tab-el-active">
                                    ...
                                    <div class="row x-gap-20 y-gap-20">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-input">
                                                <x-text-input id="section_heading" name="section_heading" type="text" :value="old('section_heading', $section['section_heading'])" readonly/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-input">
                                                <x-text-input id="short_title" name="short_title" type="text" :value="old('short_title', $section['short_title'])" readonly/>
                                ...
                                <div class="border-top-light mt-30 mb-30"></div>
                                 ...
                                 <div class="text-15 text-light-1">Section content point :</div>

                                    <div class="row y-gap-30 items-center">
                                      
                                        <div class="col-md-2">
                                            <div class="d-flex ratio ratio-1:1 w-200">
                                                <img src="#" alt="image" class="img-ratio rounded-4" id="image_1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="d-inline-block mt-15">
                                                <input type="file" name="image" class="button -dark-1 bg-blue-1 text-white" style="padding: 10px" onchange="readURL(this);" data-image-container="image_1" required>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-input">
                                                <textarea required="" rows="5" name="title"></textarea>
                                                <label class="lh-1 text-16 text-light-1">Title</label>
                                            </div>
                                        </div>
                                        @if ($section['section_type']=='safe_travel_with_us')
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-input">
                                                <x-text-input name="from" type="text"/>
