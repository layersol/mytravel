                ...
                <div class="row y-gap-30 items-center">
                  <div class="col-auto">
                    <div class="d-flex ratio ratio-1:1 w-200">
                      <img src="{{asset('storage/images/testimonials/'.$testimonial['image'])}}" alt="image" class="img-ratio rounded-4" id="db_user_image_upload">
                  ...
                  <div class="row x-gap-20 y-gap-20">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-input">
                        <x-text-input id="name" name="name" type="text" :value="old('name',$testimonial['name'])" required />
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-input ">
                        <x-text-input id="designation" name="designation" type="text" :value="old('designation',$testimonial['designation'])" required/>
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-input ">
                              <textarea required="" rows="5" name="text">{{$testimonial['text']}}</textarea>
