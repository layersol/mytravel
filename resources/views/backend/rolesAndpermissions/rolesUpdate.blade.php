      ...
      <div class="dashboard__content bg-light-2">
        <div class="row y-gap-20 justify-between items-end pb-60 lg:pb-40 md:pb-32">
          <div class="col-auto">
            ...
            <h1 class="text-30 lh-14 fw-600">Update Role</h1>
            <div class="text-15 text-light-1">update new role from here.</div>
        ...
        <div class="py-30 px-30 rounded-4 bg-white shadow-3 mt-2">
          <div class="tabs -underline-2 js-tabs">
            <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls">
              ...
              <div class="col-auto">
                <button class="tabs__button text-18 lg:text-16 text-light-1 fw-500 pb-5 lg:pb-0 js-tabs-button is-tab-el-active" data-tab-target=".-tab-item-1">Role Information</button>
              </div>

            </div>


            <form action="{{ route('RolesandPermissions/roles.Update',$role->id) }}" method="post">
                @csrf
                  ...
                  <div class="row x-gap-20 y-gap-20">
                    <div class="col-12">
                        ...
                        <div class="form-input ">
                            <x-text-input id="name" type="text" name="name"  :value="old('name',$role->name)" required autocomplete="name"/>
                          <label class="lh-1 text-16 text-light-1">Role Name</label>
                        </div>
          ...
          <div class="col-12">
            <div class="row ">
              <form method="POST" action="{{ route('assignRevokePermissionRole',$role->id) }}" >
                @csrf
              <div class="col-auto">
                <div class="text-16 lh-12 text-dark-1 fw-500 mb-30 mt-10">Permissions this role have</div>
